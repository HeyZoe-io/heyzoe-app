...
comment on column public.contacts.free_text_replies_since_cta is
  '0 = full sales-flow CTA not yet sent this run. >=1 = full CTA already sent (compact register + question buttons on later answers). Reset to 0 on greeting / product re-pick.';
