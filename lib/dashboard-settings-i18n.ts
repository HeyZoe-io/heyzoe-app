  ...
  he: {
    ...
    about: {
      ...
      sections: {
        ...
        knowledgeQa: { label: "ידע לזואי", hint: "שאלה ותשובה" },
      },
      ...
      phones: "מספרי טלפון",
      phonesHint: 'להפעלת פלואו המכירה שלחו: "אשמח לפרטים" או "בואו נתחיל"',
      phonesHintLead: "להפעלת פלואו המכירה שלחו:",
      phonesHintRest: ' "אשמח לפרטים" או "בואו נתחיל"',
      ...
      knowledgeHintQa: "שאלה ותשובה — זואי מזהה לפי הנושא",
      facts: "עובדות על העסק",
      factsHint: "נקודות שכדאי שזואי תדע. טקסט ב״מרכאות״ = ציטוט מדויק לליד במלואו (בלי קיצור); מחוץ למרכאות = הוראות לזואי. בלי מרכאות — זואי תנסח מהתשובה (לא מהשאלה)",
      factsHintQa:
        "שאלה = הנושא (גם בניסוחים דומים, למשל אימון היכרות = אימון ניסיון). תשובה = מה זואי תגיד לליד. טקסט ב״מרכאות״ = ציטוט מדויק.",
      qaQuestion: "שאלה",
      qaAnswer: "תשובה",
      qaQuestionPlaceholder: "למשל: אימון ניסיון",
      qaAnswerPlaceholder: "מה זואי תענה לליד",
  ...
  en: {
    ...
    about: {
      ...
      sections: {
        ...
        knowledgeQa: { label: "Knowledge for Zoe", hint: "Question & answer" },
      },
      ...
      phonesHint: 'To start the sales flow, send: "I\'d like details" or "Let\'s start"',
      phonesHintLead: "To start the sales flow, send:",
      phonesHintRest: ' "I\'d like details" or "Let\'s start"',
      ...
      knowledgeHintQa: "Question and answer — Zoe matches by topic",
      facts: "Business facts",
      factsHint: "Points Zoe should know. Text in \"quotes\" = exact wording to the lead in full (no shortening); outside quotes = instructions for Zoe. Without quotes — Zoe phrases the answer (not the question)",
      factsHintQa:
        "Question = the topic (similar phrasings count, e.g. intro class = trial class). Answer = what Zoe tells the lead. Text in \"quotes\" = exact wording.",
      qaQuestion: "Question",
      qaAnswer: "Answer",
      qaQuestionPlaceholder: "e.g. trial class",
      qaAnswerPlaceholder: "What Zoe should tell the lead",
      addQaPair: "Add question and answer",
