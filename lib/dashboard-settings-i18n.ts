...
export const dashboardSettingsI18n = {
  he: {
    ...
    products: {
      ...
      price: "מחיר",
      pricePlaceholder: "80",
      priceHint: "מספר בלבד — זואי מוסיפה ₪",
    ...
    salesFlow: {
      ...
      customLinkCta: "לינק קבוע",
      customLinkCtaHint: "כפתור נוסף עם לינק שלא נשאב מהמוצרים — למשל שני שיעורי היכרות",
      customLinkCtaUrl: "כתובת הלינק",
      customLinkCtaPlaceholder: "שני שיעורי היכרות",
  ...
  en: {
    ...
    products: {
      ...
      price: "Price",
      pricePlaceholder: "80",
      priceHint: "Number only — Zoe adds ₪",
    ...
    salesFlow: {
      ...
      customLinkCta: "Fixed link",
      customLinkCtaHint: "Extra button with a link that is not taken from Products — e.g. two intro classes",
      customLinkCtaUrl: "Link URL",
      customLinkCtaPlaceholder: "Two intro classes",
