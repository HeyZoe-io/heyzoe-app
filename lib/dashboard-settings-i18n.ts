...
export const dashboardSettingsI18n = {
  he: {
    ...
    about: {
      ...
      phonesHintLead: "להפעלת פלואו המכירה",
      phonesHintRest: " שלחו: בואו נתחיל!, היי, הי, אשמח לפרטים, או אשמח לשמוע פרטים",
      ...
      factsHint: "נקודות שכדאי שזואי תדע. טקסט ב״מרכאות״ = ציטוט מדויק לליד; מחוץ למרכאות = הוראות לזואי. בלי מרכאות — זואי תנסח מהתשובה (לא מהשאלה)",
      removeRow: "הסר שורה",
      addFact: "הוסף עובדה",
  ...
  en: {
    ...
    about: {
      ...
      phonesHintLead: "To start the sales flow",
      phonesHintRest: ", send: Let's start!, hi, hey, or I'd like details",
      ...
      factsHint: "Points Zoe should know. Text in \"quotes\" = exact wording to the lead; outside quotes = instructions for Zoe. Without quotes — Zoe phrases the answer (not the question)",
