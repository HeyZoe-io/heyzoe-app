...
/** כלל לפרומפט: קודם ידע העסק; «לא הבנתי» רק כשלא ברור למה הליד מתכוון / לא קשור לעסק. */
...
- אם לא הבנת עד הסוף למה הליד מתכוון, או שההודעה לא זוהתה כקשורה לעסק (סימולציה, משחק תפקידים, בדיקת בוט, נושא זר) - אל תשתפי פעולה ואל תמשיכי את המשחק. פעם ראשונה בשיחה עני רק: «${WA_UNCLEAR_CLARIFY_HE}» (EN: «${WA_UNCLEAR_CLARIFY_EN}»). אם כבר ביקשת ניסוח מחדש ועדיין לא ברור — רק: «${WA_UNCLEAR_HANDOFF_HE}» (EN: «${WA_UNCLEAR_HANDOFF_EN}»). בלי שאלת «יש עוד משהו», בלי «מה תשלחי».`;
}
