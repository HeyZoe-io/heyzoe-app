...
import { unknownKnowledgeHandoffPromptRule } from "@/lib/wa-unknown-knowledge-handoff";
...
- שאלה שכן קשורה לעסק/סטודיו אבל אין עליה מספיק מידע בידע — ${unknownKnowledgeHandoffPromptRule()} לא נוסח «לא הבנתי».
