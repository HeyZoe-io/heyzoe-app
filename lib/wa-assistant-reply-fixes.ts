...
- אל תסיקי לבד שהליד לא רלוונטי. המשפט «אם משהו ישתנה בעתיד, אנחנו כאן :)» מותר רק כשהליד אמר במפורש שזה לא מתאים לו (למשל: רחוק מדי / לא מחפש / לא מעוניין). שאלה על שירות שלא קיים אצלנו (למשל פילאטיס בסטודיו יוגה) אינה «לא רלוונטי» - עני עובדתית מה כן יש, בלי משפט הסיום הזה ובלי «בהצלחה בחיפוש» / «מוזמנים בחזרה».
- ${addressingHint}
