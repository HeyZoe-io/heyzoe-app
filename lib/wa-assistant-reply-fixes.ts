...
- איות: «אימון» לא «אימן»; «להצטרף» לא «להצטפן»; «לומדים» לא «למדים»; «אין לי» לא «לא יש לי»; «בהצלחה» לא «מצליחה»; «החלמה מהירה» לא «בהחלמה מהירה»; «בדיוק» לא «לבדיוק»; «לוודא» לא «ליוודע»; «יכולה» לא «יוכלה»; «מתאים לך» לא «מתוקף לך»; «רצפת האגן» לא «הרצפה האגן»; «להגיד לה» לא «להגידה לה».
