 ...
 * הסטודיו של ג׳ו + לקוחות חדשים מקבלים UI של שאלה/תשובה.
 */
const LEGACY_SINGLE_LINE_KNOWLEDGE_SLUGS = new Set(["limitless", "info-2815"]);
...
- שדה «שאלה/נושא» = מתי להשתמש בפריט. זו הכוונה, לא ניסוח מדויק של הליד.
- שדה «תשובה לליד» = מה להגיד. אל תעתיקי את השאלה/הנושא לליד.
