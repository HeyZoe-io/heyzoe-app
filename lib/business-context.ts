...
function formatUnknownKnowledgeBlock(_phoneDisplay: string, platform: ZoePlatformGuidelines): string {
...
${staticBlock || `עני רק את המשפט הזה, בדיוק, בלי תוספת — לא טלפון, לא לינק, לא שאלת המשך: «${ZOE_UNKNOWN_KNOWLEDGE_HANDOFF_REPLY}»`}
- בכל מקרה של חוסר ידע (ברור מה שואלים ואין מידע בידע) — רק הנוסח המוסכם למעלה. המערכת מעבירה לצוות.
- אסור «לא יש לי» / «לא יש לי את הפרטים».
