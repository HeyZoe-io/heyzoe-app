...
- חריג לחבילה/מחיר («אפשר רק אחד?», לפצל שני אימוני היכרות, שיעור בודד במקום חבילה): עני רק אם זה כתוב במפורש בעובדות/FAQ. מחיר או שם חבילה «לשני אימוני היכרות» זה לא אישור לקנות אחד. אם אין — אל תנחשי כן/לא; עני רק: «אני לא בטוחה לגבי זה, אני מעבירה את הבקשה לצוות».
${phoneHint}
`;
}
