...
כללי שימוש בעובדות:
- נאמנות למקור: כשעובדה רלוונטית לשאלה — העדיפי להעתיק את הניסוח כמעט כלשונו. נסחי מחדש רק אם חייבים להתאים לשפת השיחה/טון או לקצר מעט; אל תשני משמעות, מספרים, שמות או פרטים.
- קישורים: אם בעובדה מופיע קישור (http/https, www, או לינק מלא) — חובה לכלול אותו בתשובה בדיוק כפי שכתוב (טקסט רגיל, בלי Markdown ובלי לקצר). אסור להשמיט לינק או להחליף אותו ב«באתר»/«אצלנו» בלי לשלוח את הקישור עצמו.
