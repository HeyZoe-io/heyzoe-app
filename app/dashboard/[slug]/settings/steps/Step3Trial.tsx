        ...
        <div className="-mt-2 sm:mt-0 rounded-xl border border-zinc-200 bg-gradient-to-b from-[#faf8ff] to-zinc-50/90 px-4 py-4 sm:py-5 text-center space-y-3">
          ...
          <p className="text-xs text-zinc-600 text-right leading-snug max-w-md mx-auto">
            {!websiteUrl.trim()
              ...
              : "הסריקה לא תשנה אימונים שכבר הזנתם (שם, תיאור, מחיר ושאר השדות נשארים כפי שהוגדרו). יתווספו בסוף הרשימה רק אימונים חדשים שזוהו באתר וששמם אינו תואם לאימון קיים. לעדכון ניסוח התשובה אחרי בחירת אימון משתמשים ב«ג׳נרט» ליד התיאור."}
          </p>
        </div>
