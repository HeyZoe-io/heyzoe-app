...
- description: תיאור מדויק מהאתר (עדיף להעתיק כמעט כפי שהוא) — 1–3 משפטים קצרים. אם באתר כתוב "שיעור/שיעורי" השאר כך (אל תהפוך ל"אימון/אימוני"). אל תשלב בבת אחת "אימוני" ו"שיעורי" (כפילות). אם הניסוח כבר מספק — אל תערוך, רק תקן מעט רווחים/נקודות. אפשר ניסוח טבעי — "מגוונים ומתאימים לרמות…" או "מתמקדים ב…" — לפי מה שכתוב באתר; לא חייב "מתמקדים".
