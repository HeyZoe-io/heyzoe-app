...
export async function POST(req: NextRequest) {
  ...
  if (asksWhereToEditBotConversation) {
    ...
    deterministic = {
      clean:
        'טמפלייטים וטריגרים מוגדרים בטאב "אוטומציות" בדשבורד. שם יוצרים תבניות וואטסאפ, מגדירים "טמפלייט הפתיחה ללידים", ומוסיפים טריגרים (למשל ליד מאתר/קמפיין). לחיבור לאוטומציה (Zapier וכו\') יש קישור "איך מחברים לאוטומציה?" בתוך הטריגר «ליד מאתר/קמפיין».',
