...
- "מסלול מכירה" - המעטפת שמכילה את כל הגדרת הבוט, מחולקת ל-5 שלבים:
  ...
  4. "שיחה" - הניסוחים שזואי אומרת ללידים: פתיחה, שאלות חימום, תשובות, וכפתורי הקריאה לפעולה (הרשמה לניסיון, מערכת שעות, מחירי מנויים).
  5. "פולואפ" - הודעות מעקב אוטומטיות שנשלחות ללידים שלא נרשמו או לא הגיבו.
- עריכת השיחה של הבוט מול הליד (השאלות, התגובות וה-flow) נעשית בשלב "שיחה" בתוך "מסלול מכירה".
