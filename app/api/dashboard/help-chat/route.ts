...
- "טמפלייטים" - ניהול תבניות וואטסאפ וטריגרים אוטומטיים (ראו למטה).
...
- הגדרת טמפלייט פתיחה ללידים וטריגרים — בטאב "טמפלייטים".
...
export async function POST(req: NextRequest) {
  ...
  if (asksWhereToEditBotConversation) {
    ...
    deterministic = {
      clean:
        'טמפלייטים וטריגרים מוגדרים בטאב "טמפלייטים" בדשבורד. שם יוצרים תבניות וואטסאפ, מגדירים "טמפלייט הפתיחה ללידים", ומוסיפים טריגרים (למשל ליד מאתר/קמפיין). לחיבור לאוטומציה (Zapier וכו\') יש כפתור "איך מחברים לאוטומציה?" בעמוד.',
