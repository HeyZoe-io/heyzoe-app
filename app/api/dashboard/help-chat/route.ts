...
- "לידים" - ניהול הלידים שנכנסו: סינון לפי תאריך וסטטוס, שינוי סטטוס ידני (נרשם / לא רלוונטי / ללא מענה / ביקש נציג), מעבר לשיחות של ליד.
...
- טריגרים אוטומטיים (דורשים חיבור Arbox לטריגרים מסוימים):
  ...
  · רכישה, סירוב אשראי, נוכחות בשיעור ניסיון, יום הולדת, מנוי עומד לפוג, כרטיסייה עומדת לפוג — טריגרים מבוססי Arbox.
