...
- 7 ימי ניסיון חינם, ללא התחייבות, ללא כרטיס אשראי
- ניתן לבטל בכל עת, אין חוזים
- Starter: ₪349/חודש עד 100 שיחות
- Pro: ₪499/חודש — כל מה שב-Starter + העלאת מדיה לצ'אט + עד 500 שיחות + ליווי הקמה + אנליטיקס
...
- כשספקנות לגבי המוצר - "7 ימי ניסיון חינם, מה הכי גרוע שיכול לקרות?"
